...
<section class="section-hero">
    ...
    <div style="position:relative;max-width:700px;margin:0 auto;">
        ...
        <h1 style="font-size:clamp(1.8rem,5vw,2.8rem);color:#fff;font-family:'Playfair Display',serif;margin-bottom:1rem;line-height:1.2;">
        ...
        <div style="display:flex;gap:1rem;justify-content:center;flex-wrap:wrap;">
            <a href="{{ route('register') }}" style="background:#fff;color:var(--primary);padding:.9rem 2rem;border-radius:8px;font-weight:700;font-size:1rem;text-decoration:none;">
                📅 Pedir cita online
            </a>
...
<section class="section-public" style="padding-top:5rem;">
    ...
    <p style="text-align:center;color:var(--text-light);margin-bottom:3rem;">Tratamientos para toda la familia en un entorno cómodo y moderno.</p>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:1.5rem;">
        ...
        <div class="card" style="text-align:center;transition:transform .2s,box-shadow .2s;" onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 8px 24px rgba(0,0,0,.12)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
            ...
            <p style="font-size:.85rem;color:var(--text-light);">{{ $desc }}</p>
        </div>
        @endforeach
    </div>
</section>
...
{{-- ── POR QUÉ ELEGIRNOS ─────────────────────────────────────────────────── --}}
<section style="background:#fff;padding:4rem 2rem;border-top:1px solid var(--gray-200);border-bottom:1px solid var(--gray-200);">
    <div class="grid-2col" style="max-width:900px;margin:0 auto;gap:3rem;align-items:center;">
        <div>
            ...
            <ul style="list-style:none;display:flex;flex-direction:column;gap:.75rem;">
                ...
                <li style="font-size:.95rem;color:var(--text-light);">{{ $item }}</li>
                @endforeach
            </ul>
        </div>
        <div style="background:var(--primary-light);border-radius:16px;padding:2rem;text-align:center;">
            <div style="font-size:4rem;margin-bottom:1rem;">📱</div>
            <h3 style="margin-bottom:.5rem;">App para pacientes</h3>
            <p style="font-size:.9rem;color:var(--text-light);margin-bottom:1.5rem;">
                Gestiona tus citas, consulta tu historial y recibe recordatorios directamente en tu móvil Android.
            </p>
            <div style="background:var(--primary);color:#fff;padding:.6rem 1.2rem;border-radius:8px;font-size:.85rem;font-weight:600;display:inline-block;">
...
{{-- ── CONTACTO / UBICACIÓN ──────────────────────────────────────────────── --}}
<section style="padding:4rem 2rem;max-width:900px;margin:0 auto;display:grid;grid-template-columns:repeat(auto-fit,minmax(min(100%,340px),1fr));gap:2rem;align-items:start;">
    <div>
        <h2 style="font-size:2rem;margin-bottom:1rem;">Encuéntranos</h2>
        <div style="display:flex;flex-direction:column;gap:.75rem;color:var(--text-light);font-size:.95rem;">
        ...
        <table style="font-size:.9rem;border-collapse:collapse;width:100%;">
            <tr><td style="padding:.3rem .5rem;color:var(--text-light);">Lunes – Viernes</td><td style="padding:.3rem .5rem;font-weight:600;">9:00 – 14:00 / 16:00 – 20:00</td></tr>
            <tr><td style="padding:.3rem .5rem;color:var(--text-light);">Sábado</td><td style="padding:.3rem .5rem;font-weight:600;">9:00 – 13:00</td></tr>
            <tr><td style="padding:.3rem .5rem;color:var(--text-light);">Domingo</td><td style="padding:.3rem .5rem;color:#999;">Cerrado</td></tr>
        </table>
    </div>
    <div>
        <div style="background:var(--gray-50);border-radius:12px;height:250px;display:flex;align-items:center;justify-content:center;border:1px solid var(--gray-200);">
